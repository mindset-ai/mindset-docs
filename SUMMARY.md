...
* [Features](platform/features/README.md)
  ...
  * [Knowledge Graph](platform/features/knowledge-graph-workflow/README.md)
    * [Content Discovery](platform/features/knowledge-graph-workflow/content-discovery.md)
      * [Setting up Content Discovery carousels](platform/features/knowledge-graph/content-discovery/setting-up-content-discovery-carousels.md)
      * [‘Trending’ tab calculations](platform/features/knowledge-graph/content-discovery/trending-tab-calculations.md)
    * [Knowledge Assistant](platform/features/knowledge-graph/knowledge-assistant.md)
      * [Setting up the Knowledge Graph Workflow](platform/features/knowledge-graph/knowledge-assistant/setting-up-the-knowledge-graph-workflow.md)
      * [Configuring the Knowledge Graph Banks](platform/features/knowledge-graph/knowledge-assistant/configuring-the-knowledge-graph-banks.md)
  ...
  * [Facilitation](platform/features/facilitation/README.md)
    * [Configuring Facilitations](platform/features/facilitation/configuring-facilitations.md)
    * [Inviting end-users into a Facilitation via the invite code](platform/features/facilitation/inviting-end-users-into-a-facilitation-via-the-invite-code.md)
    * [Manually adding end-users to a Facilitation](platform/features/facilitation/manually-adding-end-users-to-a-facilitation.md)
